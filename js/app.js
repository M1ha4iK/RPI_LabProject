...
console.log('Здравствуйте, этот лабораторный проект выполнил Смагин Михаил Сергеевич, группа 281076.');
console.log('Проект представляет собой игру "Пятнашки", в которой необходимо сложить цифры по порядку от 1 до 15.');
console.log('В проекте присутствуют такие дополнтельные функции, как счетчик ходов, таймер, возможность включение или отключения звука и кнопки запуска таймера и рестарта игры.');
