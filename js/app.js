...
console.log('Здравствуйте, этот лабораторный проект выполнил Смагин Михаил Сергеевич, группа 281076. \tПроект представляет собой игру "Пятнашки", в которой необходимо сложить цифры по порядку от 1 до 15. \tВ проекте присутствуют такие дополнтельные функции, как счетчик ходов, таймер, возможность включение или отключения звука и кнопки запуска таймера и рестарта игры.');
